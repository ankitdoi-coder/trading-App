...
public class TradeController {
    ...
    public TradeController(BybitTradingService bybitService, BinanceTradingService binanceService, ActiveTradeService activeTradeService) {
    ...
    public ResponseEntity<?> executeTrade(@RequestBody Map<String, Object> request) {
        try {
            ...
            if (side.equalsIgnoreCase("BUY") && request.containsKey("stopLoss") && request.containsKey("takeProfit") && request.containsKey("buyPrice")) {
